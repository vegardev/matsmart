 ...
 * On a successful request, the response body contains a JSON object with all grocery items.
 ...
 *
 * @returns {Promise<NextResponse>} A promise that resolves to a NextResponse object.
 * On a successful request, the response body contains a JSON object with the submitted grocery item and its ID.
 * On a failed request, the response body contains an error message.
 */
